<div class="m-1 h-100 border-end border-secondary position-fixed" style="width: 300px; height: 100vh; overflow-y: auto;">
    <div class="py-4">
        <div class="mb-3">
            <div class="d-flex align-items-center">
                ...
                @else
                <a href="{{ route('login')}}" class="d-flex align-items-center text-decoration-none" style="color: inherit;">
    ...
    <ul class="nav flex-column px-3">
        ...
        <li class="nav-item d-flex align-items-center">
            ...
            <a class="nav-link text-light" href="{{ route('notifications.index') }}">Notifikasi</a>
        </li>
        <li class="nav-item d-flex align-items-center">
            <i class="fa-solid fa-lg pe-2 fa-plus" style="color: #4CC2D0;"></i>
            <a class="nav-link text-light" href="{{ route('createPost') }}">Posting</a>
        </li>
        <li class="nav-item d-flex align-items-center">
